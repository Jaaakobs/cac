...
export default function CompanyCard({ company }: CompanyCardProps) {
  ...
  return (
    <Link href={`/agencies/${company.id}`} passHref>
      <div className="flex flex-col items-start p-4 border border rounded-lg bg-accent shadow-sm hover:shadow-lg transition-shadow duration-300 w-full cursor-pointer">
