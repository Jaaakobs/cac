...
const JobCard = ({ job }: JobProps) => {
  ...
  return (
    <Link href={`/jobs/${job.id}`} passHref>
      <div className={`relative p-6 bg-accent rounded-lg shadow-md mb-6 cursor-pointer hover:shadow-lg transition-shadow duration-300 ${isMobile ? 'flex flex-col' : 'flex items-center'} h-full w-full`}>
